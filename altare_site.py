...
"""
altare_site.sh – dash.altare.site

Auth via cookie (after Discord login in browser).

Get cookie:
1. Login at https://dash.altare.site
2. Open DevTools (F12) → Network
3. Find request to api-india.altare.site
...
API_BASE  = "https://api-india.altare.site"
DASH_BASE = "https://dash.altare.site"
UA = (
...
class Bot:
    ...
    async def run(self):
        if not self.cookie:
            ...
            log("How to get cookie: F12 -> Network -> any request to api-india.altare.site -> Copy Cookie header", "..")
            return
...
async def main():
    p = argparse.ArgumentParser(
        description="altare.sh AFK Bot v2 (dash.altare.site)",
        ...
        epilog=(
            ...
            "How to get cookie:\n"
            "  1. Open https://dash.altare.site, login with Discord\n"
            "  2. F12 -> Network -> click any request to api-india.altare.site\n"
